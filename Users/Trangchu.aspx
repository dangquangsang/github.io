<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Trangchu.Master" AutoEventWireup="true" CodeBehind="Trangchu.aspx.cs" Inherits="TruongDhv.Users.Trangchu1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <hr />
    <br />
    <asp:DataList ID="DataList1" runat="server" DataKeyField="New_ID" DataSourceID="SqlDataSource1" Width="100%">
        <ItemTemplate>
            <table>
                <tr>
