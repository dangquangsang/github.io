<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Quantri_web.Master" AutoEventWireup="true" CodeBehind="QuanlyUser.aspx.cs" Inherits="TruongDhv.Admin.QuanlyUser" %>
    ...
    <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataKeyNames="Username"
        ...
        <EditItemTemplate>
            ...
            <asp:LinkButton ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update"
                Font-Bold="True" Text="Cập nhật"></asp:LinkButton>&nbsp;
            <asp:LinkButton ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel"
                Font-Bold="True" Text="Hủy bỏ"></asp:LinkButton>
        </EditItemTemplate>
        <InsertItemTemplate>
            <div style="text-align: center">
                <table style="width: 100%">
        ...
        <ItemTemplate>
            ...
            <asp:LinkButton ID="EditButton" runat="server" CausesValidation="False" CommandName="Edit"
                Font-Bold="True" Text="Sửa"></asp:LinkButton>&nbsp;
            <asp:LinkButton ID="DeleteButton" runat="server" CausesValidation="False" CommandName="Delete"
                Font-Bold="True" Text="Xóa"></asp:LinkButton>&nbsp;
            <asp:LinkButton ID="NewButton" runat="server" CausesValidation="False" CommandName="New"
                Font-Bold="True" Text="Nhập"></asp:LinkButton>
        </ItemTemplate>
    </asp:FormView>
