<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Quantri_web.Master" AutoEventWireup="true" CodeBehind="Nhomtin.aspx.cs" Inherits="TruongDhv.Admin.Nhomtin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataKeyNames="New_ID"
        ...
        <EditItemTemplate>
            ...
            <asp:Label ID="New_IDLabel1" runat="server" Text='<%# Eval("New_ID") %>'></asp:Label></td>
                    </tr>
                    <tr>
                        <td width="33%" style="font-weight: bold; color: #0066cc" align="right">
                            Group_ID:</td>
        ...
        <ItemTemplate>
            ...
            <asp:LinkButton ID="EditButton" runat="server" CausesValidation="False" CommandName="Edit"
                Text="Sửa" Font-Bold="True"></asp:LinkButton>
            &nbsp;
            <asp:LinkButton ID="DeleteButton" runat="server" CausesValidation="False" CommandName="Delete"
                Text="Xóa" Font-Bold="True"></asp:LinkButton>&nbsp; &nbsp;<asp:LinkButton ID="NewButton" runat="server" CausesValidation="False" CommandName="New"
                Text="Nhập" Font-Bold="True"></asp:LinkButton>
        </ItemTemplate>
    </asp:FormView>
