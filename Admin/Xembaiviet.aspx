<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Quantri_web.Master" AutoEventWireup="true" CodeBehind="Xembaiviet.aspx.cs" Inherits="TruongDhv.Admin.Xembaiviet" %>
    ...
    <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataKeyNames="New_ID"
        ...
        <EditItemTemplate>
            ...
            <asp:LinkButton ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update"
                Text="Cập nhật" Font-Bold="True"></asp:LinkButton>
            <asp:LinkButton ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel"
                Text="Hủy bỏ" Font-Bold="True"></asp:LinkButton>
        </EditItemTemplate>
        <InsertItemTemplate>
            Group_ID:
            <asp:TextBox ID="Group_IDTextBox" runat="server" Text='<%# Bind("Group_ID") %>'>
