<%@ Page Title="" Language="C#" MasterPageFile="~/Trangchu.Master" AutoEventWireup="true" CodeBehind="Chitiet.aspx.cs" Inherits="TruongDhv.Chitiet" %>
        ...
        <ItemTemplate>
            ...
            <div style="text-align: center">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td style="height: 21px; text-align: justify;" width="20%">
                            <asp:Image ID="Image1" runat="server" Height="200px" ImageUrl='<%# "Pictures/"+Eval("Picture") %>'
                                Width="200px" /></td>
                        <td style="height: 21px; text-align: justify;" width="80%">
